                    ...
                    <div class="table-responsive">
                        ...
                        <thead style = "background-color:#28a745; color:#FFFF" >
                                ...
                                <?php 
                                        ...
                                        $query = $doctorModel -> query("SELECT * FROM appointments WHERE doctor_id = $doctorID and status = 'Confirmed' and done='1' and req='1'"); 
                        ...
                        <a href="<?php echo base_url('AppointmentsPractitioners/index/')?>" class="btn btn-success float-end btn-sm">Go to Upload Medical Document</a>
                    </div>
</div>
</div>