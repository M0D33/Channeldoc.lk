        ...
        <div class="col-md-4 order-md-2 mb-4">
            <div class = "contact-section">
                    <div class= "contact-info">
                        <div><i class ="fas fa-map-marker-alt"></i> 95b Srimath Anagarika Dharmapala Mawatha, Colombo 00007, Sri Lanka</div>
                        <div><i class ="fas fa-envelope"></i> channeldoc.lk@gmail.com</div>
                        <div><i class ="fas fa-phone"></i> (+94) 77 579 2352</div>
                    </div>
                    <hr>
                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <div class="col-md-6 mb-3">
                        <input type="text" id="name" name="name" class = "text-box" placeholder="Your Name" require="yes">
                    </div>
                    <div class="col-md-6 mb-3">
                        <input type="email" id="email" name="email" class = "text-box" placeholder="Your Email" require="yes">
                    </div>
                        <textarea id="message" name="message" rows="5" placeholder="Your Message" require="yes"></textarea>
