  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-center">
		...
		<a class="nav-link" href=<?php echo site_url('/login/index') ?>>
            Logout
          </a>         </ul>
</ul>
...
<!--Carousel-->
  ...
  <div class="carousel-inner">
    ...
    <img class="d-block w-100 img-fluid" src="../public/assets/images/banner.jpg" alt="...">
    </div>
  </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="..public/assets/images/doctors-1.jpg" class="img-fluid" alt=""></div> 
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="..public/assets/images/doctors-2.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="..public/assets/images/doctors-3.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="..public/assets/images/doctors-4.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
